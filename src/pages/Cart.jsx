...

    {
      ...
      <div className="row">
        <div className="col-lg-8">
          <table className='table shadow rounded m-2'>
            <thead>
              <tr>
                <th>#</th>
                <th>Product</th>
            ...
            <tbody>
              ...
              cartArray.map((product,index)=> (
                <tr key={index}>
                  ...
                  <td>{product.price}</td>
                  <td><Button onClick={()=>dispatch(removeFromCart(product.id))} className='btn btn-light'><i className='fa-solid fa-trash text-danger'></i> </Button></td>
                </tr>
              ))
            }
      ...
      <div style={{height:'100vh'}} className='w-100 d-flex flex-column justify-content-center align-items-center'>
        <img height={'500px'} width={'500px'} src="https://hakimitr.com/assets/website/images/empty-cart.gif" alt="" />
